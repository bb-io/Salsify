...
public class AssetListNameDataHandler(InvocationContext context) : BaseListDataHandler(context), IAsyncDataSourceItemHandler
{
    ...
    {
        return GetListItems(context, x => x.Name);
    }
}